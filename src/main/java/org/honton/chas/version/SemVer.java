...
/**
 * A semantic version mostly following the rules at <a href="https://semver.org">semver.org</a>.
 * The major.minor.patch numbering scheme is loosened.  If minor or patch is not supplied, the
 * minor and patch attributes will be -1.
 */
@Getter
...
public class SemVer {
  ...
  private static final Pattern SEM_VER_EXACT = Pattern.compile('^'
      + "(((0|[1-9][0-9]*)(\\.(0|[1-9][0-9]*))*)"
      + "(-([0-9A-Za-z-\\.]*))?)"
      + "(\\+([0-9A-Za-z-\\.]*))?"
      + '$');
  ...
  /**
   * Any version metadata.  The suffix starting with a plus.  i.e. exp.sha.5114f85 of 1.2.3+exp.sha.5114f85
   */
