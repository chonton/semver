...
public class JarVersionsTest {
  ...
  public void testExtractMavenJars() {
    ...
    Assert.assertEquals("3.0.1+com.google.code.findbugs-annotations", actual.get("annotations-3.0.1.jar"));
    Assert.assertEquals("3.0.1+com.google.code.findbugs-jsr305", actual.get("jsr305-3.0.1.jar"));
    Assert.assertEquals("1.7.25+org.slf4j-slf4j-api", actual.get("slf4j-api-1.7.25.jar"));
  }
  ...
  public void testRemovePrincipal() {
    ...
    Assert.assertEquals("1.7.25+org.slf4j-slf4j-api", semVer.getVersion());
    Assert.assertFalse(jarVersions.getDependentJars().containsKey("slf4j-api-1.7.25.jar"));
  }
